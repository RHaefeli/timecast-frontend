...
public class MockLoginService extends LoginService {
    ...
    public MockLoginService(RestTemplate restTemplate, @Value("${wodss.timecastfrontend.api.url.token}") String apiURL) {
    ...
    public Token createToken(String email, String password) {
        ...
        // TODO: get employee from repo and validate email - password
